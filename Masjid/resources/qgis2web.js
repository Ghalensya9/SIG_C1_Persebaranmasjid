...
map.getView().fit([12535809.790189, -888159.562846, 12539560.812768, -886089.906137], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Persebaran Masjid Di Mojolangu</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (105 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini berfungsi untuk menunjukkan lokasi lokasi masjid yang tersebar pada daerah mojolangu kota malang';
            }
